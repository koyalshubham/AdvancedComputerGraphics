...
out vec4 fs_pos; // Vertex position in camera coords
...
void main(void)
{
    ...
    vec3 pe0 = gl_in[3].gl_Position.xyz;
    vec3 pe1 = gl_in[4].gl_Position.xyz;
    ...
    fs_pos = vec4(modelviewmatrix * vec4(fs_pos, 1.0));
